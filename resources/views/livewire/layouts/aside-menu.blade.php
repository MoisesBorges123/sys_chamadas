<aside class="app-sidebar">
    ...
    <div class="app-sidebar__user">
        <div class="dropdown user-pro-body text-center">
            ...
            <div class="user-info">
                <h5 class=" mb-1">{{Auth::user()->name ?? session()->get('nome')}}<i class="ion-checkmark-circled  text-success fs-12"></i></h5>
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item"  href="{{route('admin.chamadas')}}">
                ...
                <span class="side-menu__label">Turmas</span></a>
        </li>               
    </ul>
</aside>
<!--aside closed-->